<template>
    <div>
        <div class="card card-default">
            <div class="card-header"> {{ $t("Create Announcement") }}</div>

            <div class="card-body">
                <div class="alert alert-info">
                    {{ $t("Announcements you create here") }}
                </div>

                <form role="form">
                    <!-- Announcement -->
                    <div class="form-group row" :class="{'is-invalid': createForm.errors.has('body')}">
                        <label class="col-md-4 col-form-label text-md-right">{{ $t("Announcement") }}</label>
...
<script>
    const base = require('kiosk/announcements');
...
<i18n>
{
    "en": {
        ...
        "Announcements you create here": "Announcements you create here will be sent to the 'Product Announcements' section of the notifications modal window, informing your users about new features and improvements to your application."
    }
}
</i18n>