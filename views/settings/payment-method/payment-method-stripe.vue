<template>
    <div>
        ...
        <!-- Update VAT ID -->
        <div v-if="spark.collectsEuropeanVat">
            <update-vat-id :user="user" :team="team" :billable-type="billableType"></update-vat-id>
        </div>

        <!-- Update Card -->
        <update-payment-method-stripe :user="user" :team="team" :billable-type="billableType"></update-payment-method-stripe>
...
<script>
    const base = require('settings/payment-method-stripe');

    import UpdatePaymentMethodStripe from './update-payment-method-stripe'
    import RedeemCoupon from './redeem-coupon'
    import UpdateVatId from './update-vat-id'

    export default {
        name: "payment-method-stripe",
        mixins: [base],
        components: {UpdatePaymentMethodStripe, RedeemCoupon, UpdateVatId}
    }
</script>
