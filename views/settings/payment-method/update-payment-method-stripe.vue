        ...
        <div class="card-body">
            ...
            {{ form.errors.get('city') }}
                ...
                <div class="form-group row" v-if=" ! spark.collectsBillingAddress">
                    <label for="zip" class="col-md-4 col-form-label text-md-right">{{ $t("ZIP / Postal Code") }}</label>
...
<script>
    const base = require('settings/payment-method/update-payment-method-stripe');

    export default {
        name: "update-payment-method-stripe",
