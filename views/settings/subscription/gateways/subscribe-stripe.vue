            ...
            <div class="card-body">
                ...
                <form role="form">
                    ...
                    <div class="form-group row" v-show="form.use_existing_payment_method != '1'">
                        <label for="name" class="col-md-4 col-form-label text-md-right">{{ $t('Cardholder\'s Name') }}</label>
                    ...
                    <!-- Card Details -->
                    <div class="form-group row" v-show="form.use_existing_payment_method != '1'">
                        <label for="name" class="col-md-4 col-form-label text-md-right">{{ $t('Card') }}</label>
                    ...
                    <div v-if="spark.collectsBillingAddress">
                        <!-- Address -->
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">{{ $t('Address') }}</label>
                        ...
                        <!-- Address Line 2 -->
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">{{ $t('Address Line 2') }}</label>
                        ...
                        <!-- City -->
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">{{ $t('City') }}</label>
                        ...
                        <!-- State & ZIP Code -->
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">{{ $t('State & ZIP / Postal Code') }}</label>

                            <!-- State -->
                            <div class="col-sm-3">
                                <input type="text" class="form-control" v-model="form.state" placeholder="State" :class="{'is-invalid': form.errors.has('state')}">
                        ...
                        <!-- Country -->
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">{{ $t('Country') }}</label>
                        ...
                        <div class="form-group row" v-if="countryCollectsVat">
                            <label class="col-md-4 col-form-label text-md-right">{{ $t('VAT ID') }}</label>
                    ...
                    <div class="form-group row" v-if=" ! spark.collectsBillingAddress">
                        <label for="number" class="col-md-4 col-form-label text-md-right">{{ $t('ZIP / Postal Code') }}</label>
                    ...
                    <!-- Coupon -->
                    <div class="form-group row">
                        <label class="col-md-4 col-form-label text-md-right">{{ $t('Coupon') }}</label>
                    ...
                    <div class="form-group row" v-if="spark.collectsEuropeanVat && countryCollectsVat && selectedPlan">
                        ...
                        <div class="col-md-6">
                            <div class="alert alert-info" style="margin: 0;">
                                <strong>{{ $t('Tax') }}:</strong> {{ taxAmount(selectedPlan) | currency }}
                                <br><br>
                                <strong>{{ $t('Total Price Including Tax')}}:</strong>
...
<script>
    ...
    const base = require('settings/subscription/subscribe-stripe');
...
<i18n>
{
    ...
    "de": {
        ...
        "City": "Stadt",
        "State & ZIP / Postal Code": "Bundesland & Postleitzahl",
        "Country": "Land",
        "VAT ID": "VAT ID",
        "ZIP / Postal Code": "PLZ / Postleitzahl",
        "Coupon": "Gutschein",
        "Total Price Including Tax": "Gesamtpreis inkl. MwSt",
    ...
    "ru": {
        ...
        "City": "Город",
        "State & ZIP / Postal Code": "Государство и почтовый индекс",
        "Country": "Страна",
        "VAT ID": "Идентификатор НДС",
        "ZIP / Postal Code": "ZIP / Почтовый индекс",
        "Coupon": "Купон",
        "Total Price Including Tax": "Общая цена, включая налог",
    ...
    "ua": {
        ...
        "Cardholder's Name": "Ім'я власника картки",
        "Card": "Картка",
        "Address": "Адреса",
        "Address Line 2": "Рядок адреси 2",
        "City": "Місто",
        "State & ZIP / Postal Code": "Держава та поштовий індекс",
        "Country": "Країна",
        "VAT ID": "Ідентифікатор ПДВ",
        "ZIP / Postal Code": "ZIP / Поштовий індекс",
        "Coupon": "Купон",
        "Total Price Including Tax": "Загальна ціна, включаючи податок",
