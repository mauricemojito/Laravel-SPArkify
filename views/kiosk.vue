                ...
                <div class="col-md-3 spark-settings-tabs">
                    <aside>
                        ...
                        <ul class="nav flex-column mb-4 ">
                            <li class="nav-item ">
                                <a class="nav-link active" href="#announcements" aria-controls="announcements" role="tab" data-toggle="tab">
                ...
                <div class="col-md-9">
                    <div class="tab-content">
                        ...
                        <div role="tabcard" class="tab-pane" id="users">
                           <users :user="user" :plans="plans"></users>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    let base = require('kiosk/kiosk');

    import Announcements from './kiosk/announcements'
    import Metrics from  './kiosk/metrics'
    import Users from './kiosk/users'

    export default {
        name: "kiosk",
        props: ["user", "plans"],
        components: { Announcements, Metrics, Users },
        mixins: [base]
    }
</script>
